...
const ProductDetailPage = () => {
  ...
  useEffect(() => {
    const fetchProductDetails = async () => {
      try {
        ...
        // Set all products including main product
        setAllProducts([mainProduct, ...similarProducts]);
        // Set initial current product
  ...
  // Handle product switch when clicking on similar product image
  ...
  const allSizes = [...new Set(currentProduct.variants.map((v) => v.size))];
  // Replace the entire handleAddToCart function with this:
          ...
          <div className="flex flex-col md:flex-row  max-w-[1320px] mx-auto">
            ...
            <div className="w-full md:w-[498px] h-fit">
              <div className="flex flex-row justify-between">
                <h1 className="text-2xl leading-8 mb-2 font-satoshi text-[#171717]">
                  {currentProduct.name}
                </h1>
                <svg
                  width="36"
              ...
              <div className="flex items-center mb-5">
                ...
                <div className="flex items-center">
                  ...
                  <span className="flex gap-1">
                    <div className="text-[#ACACAC] font-satoshi text-[12px] ">
                      Sold By
                    </div>
                    <div className="text-[#171717] font-satoshi text-[12px]  underline underline-offset-4">
              ...
              <p className="text-2xl leading-[29.3px] font-helvetica font-medium mb-1 flex gap-1">
                ₹{" "}
                <div className="font-satoshi text-6">
                  {currentProduct.price}
                </div>
              </p>
              <p className="text-base font-normal font-satoshi text-[#ABABAB] text-[16px] ">
                    ...
                    <button
                      ...
                      className={`w-[70px] h-[70px] relative ${
                        currentProduct._id === product._id
                          ? "ring-1 ring-black after:absolute after:inset-0 after:bg-black/15"
                          : ""
                      }`}
              ...
              <div className="my-3">
                <div className="flex justify-between">
                  ...
                  <div className="font-satoshi text-base leading-5 text-[#B3B3B3]">
                    Size Guide
                  </div>
                </div>
                        ...
                        className={`p-2 border border-black relative ${
                          availableSizes.includes(size)
                            ? selectedSize === size
                              ...
                              ? "bg-white"
                              : "hover:bg-gray-100"
                            : "bg-white text-black/25 cursor-not-allowed  border-black/25"
                        }`}
                        onClick={() =>
                          availableSizes.includes(size) &&
